...
**_Geometric Probability Statement:_** $P(X = n) = (1 - p)^{n-1} * p$
...
**_Exponential Probability Statement:_** $P(X > 8) = e^\frac{−k}{u}$
...
**_Binomial Probability Statement:_** $P(X > 8) = e^\frac{−k}{u}$
...
**_Poisson Probability Statement:_** $P(X > 8) = e^\frac{−k}{u}$
