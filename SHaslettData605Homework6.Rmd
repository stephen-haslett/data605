...
```{r ThirteenStepOne}
actual_liar <- round((probability_liar * sensitivity) / ((probability_liar * sensitivity) + (probability_truth_teller * 0.1)), 4)
actual_liar
```
...
```{r ThirteenStepTwo}
truth_teller <- round((probability_truth_teller * specificiity) / ((probability_truth_teller * specificiity) + (probability_liar * 0.41)), 4)
truth_teller
```
...
```{r ThirteenStepThree}
answer <- probability_liar + 0.198 - probability_liar * sensitivity
answer
```
