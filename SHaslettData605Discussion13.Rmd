...
The Residuals vs. Fitted plot above displays some outliers in the data, but overall the variability is fairly consistent.
Additionally, the QQ plot, while not perfect, does show consistency with outliers at each end of the line.
Therefore, It seems that our multiple linear model is an appropriate model for predicting the price of cars.
