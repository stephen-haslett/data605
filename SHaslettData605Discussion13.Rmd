...
```{r, residualsHist}
# Plot a histogram of the multiple regression model's residuals.
hist(priceMultipleModel$residuals, main = 'Histogram of Residuals')
```


```{r, residualsScatter}
plot(priceMultipleModel$residuals, main = 'Scatter Plot of Residuals')
